...
<head>
	<title>Henry Heng | PALS Login</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial scale=1.0">

	<link rel="stylesheet" type="text/css" href="../css/pals-login.css">
...
<body>
	<div class="container" style="">
		<div style="z-index: 1;">
			<form action="tu_pals_login.php" autocomplete="off" method="POST" style="z-index: 3;">
				<h3>PALS Content</h3>
				<p><?php echo $alert; ?></p>
